...
Form::Form(): _name("Default"), _signedStatus(false), _signGrade(150), _executeGrade(150) {}
...
Form::Form(const Form &other): _name(other._name), _signedStatus(false),
...
int Form::beSigned(const Bureaucrat &obj) {
