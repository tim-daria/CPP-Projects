...
Fixed::Fixed(const int input) { fixedValue = input << numBits; }

Fixed::Fixed(const float input) { fixedValue = roundf(input * (1 << numBits)); }
...
void Fixed::setFixedValue(const int value) { fixedValue = value; }
