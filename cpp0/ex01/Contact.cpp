...
const std::string& Contact::get_firstname() const { return first_name; }
const std::string& Contact::get_lastname() const { return last_name; }
const std::string& Contact::get_nickname() const { return nickname; }
const std::string& Contact::get_phonenumber() const { return phone_number; }
const std::string& Contact::get_darkest_secret() const {
  return darkest_secret;
}
void Contact::set_firstname(const std::string& value) { first_name = value; }
void Contact::set_lastname(const std::string& value) { last_name = value; }
